...
import 'package:absmartly_dart/src/default_context_event_serializer.dart';
import 'package:absmartly_dart/src/json/attribute.dart';
...
import 'package:absmartly_dart/src/json/unit.dart';
    ...
    test("serialize", () {
      final event = PublishEvent(
        ...
        goals: [
          ...
          GoalAchievement(
              name: "goal2", achievedAt: 123456789, properties: null),
        ],
        attributes: [
